...
export default function AllAppointments({
  ...
  useEffect(() => {
    axios.get(`http://localhost:8011/appointments/patient${login.id}`).then((res) => {
              ...
              <Stack>
                ...
                <table className="tbjhj">
                  <tr>
                    ...
                    <td className="tblehead">DOCTOR</td>                    
 ...
 <td className="tblehead"></td>
                  ...
                  {filterAppointments.map((p, i) => (
                    <tr className="kllk">
                      ...
                      <td className="tddata">{p.doctorName}</td>
                      ...
                      <td>
                        ...
                        <Chip label="Cancel" style={{backgroundColor:'#FFB207',color:'#fff',width:'70px'}} size="small" className="jhj"/>
                        </Stack>
                        </td>
